...
/*!*****************************!*\
  !*** ./src/_mock/Alunos.js ***!
  \*****************************/
/*! exports provided: Alunos */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Alunos\", function() { return Alunos; });\nvar Alunos = [{\n  nome: \"Jonas\",\n  grades: [Math.floor(Math.random() * 11), Math.floor(Math.random() * 11), Math.floor(Math.random() * 11), Math.floor(Math.random() * 11)]\n}, {\n  nome: \"Adam\",\n  grades: [Math.floor(Math.random() * 11), Math.floor(Math.random() * 11), Math.floor(Math.random() * 11), Math.floor(Math.random() * 11)]\n}, {\n  nome: \"Marta\",\n  grades: [Math.floor(Math.random() * 11), Math.floor(Math.random() * 11), Math.floor(Math.random() * 11), Math.floor(Math.random() * 11)]\n}, {\n  nome: \"Bartosz\",\n  grades: [Math.floor(Math.random() * 11), Math.floor(Math.random() * 11), Math.floor(Math.random() * 11), Math.floor(Math.random() * 11)]\n}];\n\n//# sourceURL=webpack:///./src/_mock/Alunos.js?");
